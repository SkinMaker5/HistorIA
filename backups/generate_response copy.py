...
def generate_response(input_text, history=None, active_characters=None, active_locations=None, active_scenario=None):
    if history is None:
        history = []
    ...
    # --- Select relevant cached chunks ---
    relevant_chunks = select_relevant_chunks(input_text, summarized_chunks, chunk_embeddings, top_k=3)
